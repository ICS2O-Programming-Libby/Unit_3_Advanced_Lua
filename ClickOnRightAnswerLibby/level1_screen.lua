...
local music = audio.loadSound("Sounds/level1Music.wav")
local musicChannel
musicChannel = audio.play( music, {duration=10000000000000000000000000000000000} )
...
--[[
local function Lose()
    -- calls the you lose function once the user gets 2 questions wrong
    if (lives == 0) then  
        composer.gotoScene( "you_lose" )
    end
end
...
function scene:create( event )
    ...
    addEquationTextObject = display.newText( "", display.contentWidth*1/4, display.contentHeight*2.3/5, nil, 80 )
    ...
    numberCorrectText = display.newText("", display.contentWidth*4/5, display.contentHeight*6/7, nil, 20)

    -- create the text object that will hold the number of lives
    livesText = display.newText("", display.contentWidth*4/5, display.contentHeight*8/9, nil, 20) 
    ...
    correct = display.newText("Correct", display.contentWidth/2, display.contentHeight*1/3, nil, 30 )
    correct:setTextColor(100/255, 47/255, 210/255)
    correct.isVisible = false

    -- create the text object that will say Correct, set the colour and then hide it
    incorrect = display.newText("Incorrect", display.contentWidth/2, display.contentHeight*1/3, nil, 30 )
